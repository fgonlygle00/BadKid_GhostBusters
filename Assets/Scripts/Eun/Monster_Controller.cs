    ...
    private void Update()
    {
        ...
        if (_stat.hp <= 0)
        {
            switch(Datas.monster_Type)
            {
                ...
                case Monster_Type.monster3: GoodsData.instance._cookies += 6; break;
                case Monster_Type.monster4: GoodsData.instance._cookies += 10; break;
                case Monster_Type.boss1: GoodsData.instance._cookies += 50; break;
                case Monster_Type.boss2: GoodsData.instance._cookies += 175; break;
                case Monster_Type.boss3: GoodsData.instance._cookies += 300; break;
